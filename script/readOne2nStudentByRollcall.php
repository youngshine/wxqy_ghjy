<?php
/*
 * 点名rollcall, oop方式 class , + ajax json跨域（不用jsonp)
 * 读取某个教师teacher某个上课时间timely的一对N学生及其课程,
 */
...
class One2nStudent {
  ...
  public function getList() {	  
	  ...
	  $query = "SELECT a.*,b.studentName,b.wxID,b.gender,c.title AS kcTitle,d.fullname AS schoolsub     
		  ...
		  Where a.teacherID=$this->teacherID And a.timely_list Like '%$this->timely%' ";  
